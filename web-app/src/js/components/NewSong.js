...
export class NewSong extends Component {
    ...
    addNewSong(event) {
        ...
        newSong.setAttribute('song', document.querySelector('.song').value);
        newSong.setAttribute('artist', document.querySelector('.artist').value);
        newSong.setAttribute('album', document.querySelector('.album').value);
